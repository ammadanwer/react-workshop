...
import NotFound from './modules/Lessons/NotFound';
...
export default (
    <Switch>
        ...
        <Route path="/lesson/api-integration/repos/:user?" component={LessonAPIIntegration} />
        <Route exact path="/lesson/api-integration" component={LessonAPIIntegration} />
